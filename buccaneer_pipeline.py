#!/home/emad/Downloads/destination/ccp4-7.0/libexec/python2.7
#
...
#
"""CCP4 dispatcher for 'buccaneer_pipeline'"""
...
class Dispatcher:
    """A class to handle dispatch to 'buccaneer_pipeline'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "buccaneer_pipeline"

        # A string giving the command required for dispatch
        self.command = "/usr/bin/env ccp4-python /home/emad/Downloads/destination/ccp4-7.0/bin/buccaneer_pipeline"

        # This dispatcher points to the specified binary located in:
        self.prog_dir_path = "/home/emad/Downloads/destination/ccp4-7.0/bin"
    ...
    def get_bin(self):
        """Method to get the path to 'buccaneer_pipeline'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'buccaneer_pipeline'"""
    ...
    def call(self, wait=True):
        """
        Method to execute buccaneer_pipeline.
    ...
    def monitor(self):
        """
        Method to read output of buccaneer_pipeline and check if it has finished.
